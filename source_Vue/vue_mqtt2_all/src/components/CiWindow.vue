...
export default defineComponent({
  ...
  computed: {
    ...
    colorWindow: function (): string {
      if (this.iWindowState === 0) return '#FF6666' //    closed (light red)
      if (this.iWindowState === 1) return 'lightgreen' // open (light green)
      if (this.iWindowState === 2) return '#D00000' //    locked (red)
      return 'lightblue'
    },
