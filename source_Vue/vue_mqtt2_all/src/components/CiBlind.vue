...
export default defineComponent({
  ...
  computed: {
    ...
    colorBlind: function (): string {
      if (this.iBlindState === 0) return '#FF6666' //    closed (light red)
      if (this.iBlindState === 1) return 'lightgreen' // open (light green)
      if (this.iBlindState === 2) return '#C00000' //    locked (red)
      return 'lightblue'
    },
