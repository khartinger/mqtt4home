...
export default defineComponent({
  ...
  computed: {
    // =======standard methods==================================
    // _______find button1 object to given sid__________________
    button1: function (): Button1 | undefined {
      return ciButton1Controller.buttons1.find(button1 => button1.id === this.sid)
    },
    // _______get iButton1State_________________________________
    ...
    // _______should I draw an additional symbol?_______________
    ...
    // _______draw an additional symbol_________________________
