//_____C_InDelayOut_Demo.hpp_____________________khartinger_____
// g++ m4hMain.cpp m4hBase.cpp -o m4hInDelayOut_Demo -lmosquitto -lpthread
...
class Message2d : public Message2
{
 ...
 //int iIncmax;                     // content of placeholder inc
 //------constructor & co---------------------------------------
